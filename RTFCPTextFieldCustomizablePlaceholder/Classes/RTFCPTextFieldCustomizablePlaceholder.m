//
//  RTFCPTextFieldCustomizablePlaceholder.m
//  Resplendent
//
...
#import "RTFCPTextFieldCustomizablePlaceholder.h"

#import <ResplendentUtilities/UIView+RUUtility.h>
#import <ResplendentUtilities/RUSystemVersionUtils.h>
#import <ResplendentUtilities/RUConstants.h>
#import <ResplendentUtilities/UITextField+RUAttributes.h>

#import <RUTextSize/UITextField+RUTextSize.h>





@interface RTFCPTextFieldCustomizablePlaceholder ()
...
@implementation RTFCPTextFieldCustomizablePlaceholder
...
-(CGRect)editingRectForBounds:(CGRect)bounds
{
	...
	if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0"))
	{
		...
		{
			case UIControlContentVerticalAlignmentCenter:
				editingRect.size.height		-= CGRectGetVerticallyAlignedYCoordForHeightOnHeight([self ruTextSize].height, CGRectGetHeight(self.bounds));
				break;
